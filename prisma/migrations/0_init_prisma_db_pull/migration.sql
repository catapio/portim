...
CREATE FUNCTION public.nanoid(size integer DEFAULT 24, alphabet text DEFAULT '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ'::text) RETURNS text
    LANGUAGE plpgsql
    AS $$
DECLARE
    idBuilder text := '';
...
CREATE TABLE "public"."projects" (
    "id" CHAR(24) NOT NULL DEFAULT nanoid(),
    "name" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "public"."projects" ADD CONSTRAINT "projects_owner_uid_fkey" FOREIGN KEY ("owner_uid") REFERENCES "auth"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
